      ...
      <PesquisaProvider>
        <NavigationContainer>
          <Stack.Navigator>
            ...
            <Stack.Screen name="AcoesPesquisa" component={AcoesPesquisa} options={{ headerTintColor: '#FFFFFF', headerTitle: 'AcoesPesquisa', headerTitleStyle: {fontSize: 42, fontFamily: 'AveriaLibre-Regular'}, headerStyle: { backgroundColor: '#2B1D62', height: 80} }}/>
            <Stack.Screen name="ModificarPesquisa" component={ModificarPesquisa} options={{ headerTintColor: '#FFFFFF', headerTitle: 'ModificarPesquisa', headerTitleStyle: {fontSize: 42, fontFamily: 'AveriaLibre-Regular'}, headerStyle: { backgroundColor: '#2B1D62', height: 80} }}/>
